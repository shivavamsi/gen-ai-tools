...
- Release workflow (points to release-management-automation.md)
- .gitignore
...
the release runbook) is covered in
**[release-management-automation.md](release-management-automation.md)**. Keep one copy there rather than a second `release.yml` here.
