...
and modules) and the migration-guide template are covered in
**[release-management.md](release-management.md)** — see
...
The mutable-default-argument trap (`def f(x: list = [])`) is covered in
**[code-quality.md](code-quality.md)**.

For detailed patterns, see:
- **[api-design-patterns.md](api-design-patterns.md)** - Builder, factory, and advanced patterns
- **[api-design-evolution.md](api-design-evolution.md)** - API versioning and migration guides
