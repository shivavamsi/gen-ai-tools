...
| `model` | No | Model override for this skill's turn. Applies for the rest of the current turn; session model resumes on next prompt. **Never set this in skills generated by build-skill.** |
