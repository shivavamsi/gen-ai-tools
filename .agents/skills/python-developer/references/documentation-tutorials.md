...
- **Reference** — dry, exhaustive, structured description of the machinery: signatures, parameters, return types, errors. For a Python library this is largely your autogenerated API docs (see **[documentation-sphinx-config.md](documentation-sphinx-config.md)**). Describe, never instruct.
...
2. **README + API reference.** When the public surface grows past what a snippet can convey, add autogenerated reference docs from your docstrings (see **[documentation-sphinx-config.md](documentation-sphinx-config.md)**). Docstrings are now doing double duty as reference and as doctests.
