...
GitHub release, and the release runbook — is in **[release-management-automation.md](release-management-automation.md)**.
...
covered in **[release-management-migration.md](release-management-migration.md)**.
...
- **[release-management-automation.md](release-management-automation.md)** - Version bump scripts
- **[release-management-migration.md](release-management-migration.md)** - Migration guide template
