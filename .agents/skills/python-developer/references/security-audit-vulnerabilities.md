...
Rotate any secret that reached version control; removing the line does not undo the exposure. See **[security-audit-ci-security.md](security-audit-ci-security.md)** for the detect-secrets baseline that keeps this out of future commits.
...
Run all four tools together through `scripts/security_scan.py`; see **[security-audit-ci-security.md](security-audit-ci-security.md)** for wiring it into CI.
