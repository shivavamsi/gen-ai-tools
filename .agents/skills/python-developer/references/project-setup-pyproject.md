...
place. For the comprehensive, annotated versions of those configs see 
**[code-quality.md](code-quality.md)** (ruff and mypy) and
**[testing-strategy.md](testing-strategy.md)** (pytest and the 85% coverage gate).
