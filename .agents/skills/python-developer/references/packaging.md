...
Publishing is automated by the canonical tag-triggered release workflow in
**[release-management.md](release-management.md)** — one pipeline builds with `uv` and publishes via
...
- **[packaging-conda.md](packaging-conda.md)** - Conda / conda-forge packaging guide
